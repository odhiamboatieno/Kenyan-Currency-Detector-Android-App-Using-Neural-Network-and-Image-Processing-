    ...
    if (results != null && results.size() >= 3) {
      ...
      if (recognition != null) {
        if (recognition.getTitle() != null){
          ...
          else if(s1.equals("3 100")  )
          {
            FinalView.setText("Ksh 100");
            final MediaPlayer mp100 = MediaPlayer.create(this,R.raw.onehundred);
            TextView tv = findViewById(R.id.Final);
            tv.setOnClickListener(new View.OnClickListener() {
              @Override
              public void onClick(View v) {
          ...
          else if(s1.equals("2 200") )
          {
            FinalView.setText("Ksh 200");
            TextView tv = findViewById(R.id.Final);
            final MediaPlayer mp200 = MediaPlayer.create(this,R.raw.thundred);
          ...
          else if(s1.equals("1 500") )
          {
            FinalView.setText("Ksh 500");
            TextView tv = findViewById(R.id.Final);
            final MediaPlayer mp500 = MediaPlayer.create(this,R.raw.fhundred);
            tv.setOnClickListener(new View.OnClickListener() {
              @Override
              public void onClick(View v) {
                mp500.start();
          ...
          else if(s1.equals("0 1000") )
          {
            ...
            TextView tv = findViewById(R.id.Final);
            final MediaPlayer mp1000 = MediaPlayer.create(this,R.raw.thousand);
            tv.setOnClickListener(new View.OnClickListener() {
              @Override
              public void onClick(View v) {
                mp1000.start();
